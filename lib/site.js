...
export const SITE = {
  ...
  // GA4 Measurement ID (public client-side id, not a secret). Wired in
  // app/layout.js; only fires on the production domain.
  gaId: 'G-J501P7GG5E',
  phone: '407-624-8459',
  ...
  // Conversion links. Leave '' to hide. Paste the URLs to activate sitewide:
  //   booking -> Calendly/Square scheduling link (shows a "Book a visit" CTA)
  //   mapsUrl -> exact Google Maps place URL (powers the reviews links)
  booking: '',
  mapsUrl: '',
