...
// Uses the exact Maps place URL once SITE.mapsUrl is set; until then falls back
// to a Google search for the profile. Also used for the "leave a review" link.
export const GOOGLE_REVIEWS_URL =
  SITE.mapsUrl || 'https://www.google.com/search?q=Witt-Tech+Solutions+Kissimmee+FL+reviews'
