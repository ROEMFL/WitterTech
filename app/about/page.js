        ...
        <div className="wrap">
          ...
          <div className="hours-grid">
            ...
            <div className="hours-card reveal">
              ...
              <h3>Get in Touch</h3>
              <p>Call or text: <a href={SITE.phoneHref} style={{color:'var(--accent-deep)',fontWeight:'600'}}>{SITE.phone}</a><br/>Email: <a href={MAILTO} style={{color:'var(--accent-deep)',fontWeight:'600'}}>{SITE.email}</a><br/>Payment: Cash, Zelle, CashApp, Check</p>
            </div>
          </div>
