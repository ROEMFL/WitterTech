    ...
    <>
      ...
      <section className="problems" id="problems">
        ...
        <div className="wrap">
          ...
          <div className="pgrid">
            <Link href="/services/computer-repair" className="pcard reveal"><div className="ph"><Image src="/assets/hero.jpg" alt="Laptop repair in Central Florida" fill style={{objectFit:'cover'}} sizes="(max-width:680px) 100vw, 33vw" /></div><div className="pb"><div className="pq">&ldquo;It turns on, but nothing really happens.&rdquo;</div><span className="pcat">Laptops</span></div></Link>
            <Link href="/services/wifi-networking" className="pcard reveal"><div className="ph"><Image src="/assets/network.jpg" alt="Home Wi-Fi and network setup in the Kissimmee, Orlando area" fill style={{objectFit:'cover'}} sizes="(max-width:680px) 100vw, 33vw" /></div><div className="pb"><div className="pq">&ldquo;The Wi-Fi drops in half the house.&rdquo;</div><span className="pcat">Networks</span></div></Link>
            <Link href="/services/virus-malware-removal" className="pcard reveal"><div className="ph"><Image src="/assets/hands.jpg" alt="Computer tune-up and cleanup" fill style={{objectFit:'cover'}} sizes="(max-width:680px) 100vw, 33vw" /></div><div className="pb"><div className="pq">&ldquo;Everything&apos;s gotten slow and I don&apos;t know why.&rdquo;</div><span className="pcat">Tune-ups</span></div></Link>
            <Link href="/services/data-recovery" className="pcard reveal"><div className="ph"><Image src="/assets/pc-motherboard.jpg" alt="Component-level PC repair and data recovery in Central Florida" fill style={{objectFit:'cover'}} sizes="(max-width:680px) 100vw, 33vw" /></div><div className="pb"><div className="pq">&ldquo;I really need my photos and files back.&rdquo;</div><span className="pcat">Recovery</span></div></Link>
            <Link href="/services/smart-home-security" className="pcard reveal"><div className="ph"><Image src="/assets/living.jpg" alt="Smart home and camera installation" fill style={{objectFit:'cover'}} sizes="(max-width:680px) 100vw, 33vw" /></div><div className="pb"><div className="pq">&ldquo;We&apos;re setting up cameras, a doorbell, or a new TV.&rdquo;</div><span className="pcat">Smart home</span></div></Link>
            <Link href="/services/business-it" className="pcard reveal"><div className="ph"><Image src="/assets/network2.jpg" alt="Small business office network support" fill style={{objectFit:'cover'}} sizes="(max-width:680px) 100vw, 33vw" /></div><div className="pb"><div className="pq">&ldquo;Our office network just needs to work, reliably.&rdquo;</div><span className="pcat">Business IT</span></div></Link>
          </div>
